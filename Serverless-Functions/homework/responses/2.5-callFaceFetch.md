...
Javascript is a synchronous language, meaning that only one operation can happen at a time. However, in order to maximize efficiency (i.e. so you don't have to waste time) it allows develo
