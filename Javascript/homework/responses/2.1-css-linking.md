...
- Next, open this folder in Visual Studio Code.  You can do this by clicking "Open folder..." on VSC's Welcome page and selecting your path.
...
Next, create a new file in your week 2 folder called `style.css`. It's important that your file name matches the one you typed in your link tag's `href` attribute in your HTML file, as this will be what links your two files.
